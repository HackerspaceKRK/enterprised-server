...
def main():
	parser = argparse.ArgumentParser(description='Enterprise RFID Unique (EM4100) Access Controller Driver - MQTT<->IOboard link')
	parser.add_argument('--log', default='INFO', choices=('DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'), help='log level')
